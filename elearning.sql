...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2025 at 01:58 PM
...
INSERT INTO `enrollments` (`id`, `user_id`, `module_id`, `enrolled_at`, `completed`, `certificate_issued_at`, `certificate_url`) VALUES
(1, 14, 1, '2025-06-07 22:50:50', 1, NULL, NULL),
(2, 5, 1, '2025-06-07 23:46:46', 1, NULL, NULL);
...
(1, 'Networking', 'Making RJ-45 cables and other networking cables', 1, 5),
(4, 'Database technology', 'working withdatabase', 1, 5);
...
(7, 1, 'video', 'Wireless technology', 'wireless handover', 'contentFile-1749396037376.mp4', 'this.mp4', '2025-06-08 15:20:37', 1),
(8, 1, 'presentation', 'networking notes', 'these notes will help the learners to increase their knowledge of wireless networking', 'contentFile-1749400231201.pptx', '9march.pptx', '2025-06-08 16:30:31', 2);
...
(2, 1, 14, 0.00, 1, '2025-06-09 23:03:41');
...
(5, 'mukiza', 'alphonse', 'alpha', 'alpha@gmail.com', '$2b$10$47XZsFlx1TzPNRWwuf/as.Q9jNNHZ/7Tyw7Thdg9NCdQvHnEpH2Ie', 'learner', 1),
(14, 'kamana', 'charle', 'kamana', 'charle@gmail.com', '$2b$10$s6NALK69z3LOKXkc.dTR3uSImDp8SGNh1QzoumRd5EyfFesRP3Xc6', 'lecturer', 1),
(16, 'izere', 'emmy', 'izere@', 'emmy@gmail.com', '$2b$10$giqVBDHhnNA6oHL7xrQ9zeIVM2IGPGfuEkiYeoyCuSu.q11ykNAdK', 'administrator', 1),
(17, 'emmy', 'izere', 'emmy@', 'izere@gmail.com', '$2b$10$MLCU8nGZbWpqujZvWLKYD.6Pfi0fPVBXiDJiqVWX0XUyShhzw6K/6', 'lecturer', 1),
(18, 'innocent', 'iradukunda', 'innocent', 'iradukunda@gmail.com', '$2b$10$hb.1Vn0ejzw8SD0JJOu1zuEH0MdHd.OEtqChSPwsgl4eDPAQFm7Iy', 'learner', 1);
